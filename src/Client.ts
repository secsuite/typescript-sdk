...
import * as SecsuiteApi from "./api/index.js";
...
export class SecsuiteApiClient {
    ...
    /**
     * @param {SecsuiteApi.PredictPredictTwitterIdGetRequest} request
     * @param {SecsuiteApiClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *     })
     */
    public predictPredictTwitterIdGet(
        ...
        return core.HttpResponsePromise.fromPromise(this.__predictPredictTwitterIdGet(request, requestOptions));
    }

    private async __predictPredictTwitterIdGet(
        request: SecsuiteApi.PredictPredictTwitterIdGetRequest,
        requestOptions?: SecsuiteApiClient.RequestOptions,
