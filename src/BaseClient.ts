...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.SecsuiteApiEnvironment | string>;
...
} & AnyAuthProvider.AuthOptions<[HeaderAuthProvider.AuthOptions, HeaderAuthProvider.AuthOptions]>;
    ...
    const headers = mergeHeaders(
        {
            ...
            "X-Fern-SDK-Name": "@secsuite/typescript-sdk",
            "X-Fern-SDK-Version": "0.0.6",
            "User-Agent": "@secsuite/typescript-sdk/0.0.6",
