# Secsuite TypeScript Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Fsecsuite%2Ftypescript-sdk)
[![npm shield](https://img.shields.io/npm/v/@secsuite/typescript-sdk)](https://www.npmjs.com/package/@secsuite/typescript-sdk)

The Secsuite TypeScript library provides convenient access to the Secsuite APIs from TypeScript.
...
```sh
npm i -s @secsuite/typescript-sdk
```

## Reference

A full reference for this library is available [here](https://github.com/secsuite/typescript-sdk/blob/HEAD/./reference.md).
...
```typescript
import { SecsuiteApiClient, SecsuiteApiEnvironment } from "@secsuite/typescript-sdk";

const client = new SecsuiteApiClient({
    environment: SecsuiteApiEnvironment.Default,
});
```
...
```typescript
import { SecsuiteApiClient, logging } from "@secsuite/typescript-sdk";
